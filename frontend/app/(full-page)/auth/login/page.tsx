                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                            ...
                            <InputText id="login" type="text" value={login} onChange={(e) => setLogin(e.target.value)} placeholder="Your login" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} />
